/**
 * Implementation of the RPSAbstract class. Akhil Pillai, CSE 12, January 11, 2022
 * Name: Akhil Pillai
 * ID: A16724533
 ...
 * This file contains the implementation of the RPSAbstract class, which implements the methods that will be used in a 
 * game of Rock-Paper-Scissors to determine the winner. It also stores constant fields for various events and actions.
 */

import java.util.Random;

/**
 * The RPSAbstract class implements the methods that will be used in a game of Rock-Paper-Scissors to determine the winner.
 * It also stores constant fields for various events and actions.
 */
public abstract class RPSAbstract implements RPSInterface {
    ...
    public void play(String playerMove, String cpuMove) {
       ...
       for (int i = 0; i < this.playerMoves.length; i++) {
           if (this.playerMoves[i] == null) {
               this.playerMoves[i] = playerMove;
               break;
           }
       }
       for (int i = 0; i < this.cpuMoves.length; i++) {
            if (this.cpuMoves[i] == null) {
                this.cpuMoves[i] = cpuMove;
                break;
            }
       }
       String outcome = "";
       ...
       System.out.printf(CPU_MOVE + outcome + "\n", cpuMove);
    }  
