 ...
 * Sources used: None
 * 
 * Contains an implementation of a support ticket, 
 * similar to those used in the CSE Autograder.
...
public class Ticket implements Comparable<Ticket>{
    ...
    /**
     * Compares two tickets, for the purpose
     * of evaluating them in order.
     * @return -1 if this ticket is before other,
     * 0 if they are equal, and 1 if this ticket is after other.
     */
    @Override
    public int compareTo(Ticket other){
        //if the two tickets are equal, return 0
        if (this.ticketType.equals(other.ticketType) 
        && this.createdAt.equals(other.createdAt)) return 0;
        //if the tickets have different priorities, 
        //return -1 if this ticket has higher priority, 
        //or 1 if the other one does
        if (orderMap.get(this.ticketType).compareTo(
            orderMap.get(other.ticketType)) != 0) {
            return orderMap.get(this.ticketType).compareTo(
                orderMap.get(other.ticketType));
        }
        //if the tickets have equal priority, return -1
        //if this ticket was made first, 1 otherwise
